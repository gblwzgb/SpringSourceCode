 ...
 *
 * 这个GenericBeanDefinition变体主要用于测试期望在AnnotatedBeanDefinition上运行的代码，
 * 例如Spring的组件扫描支持中的策略实现（默认定义类是org.springframework.context.annotation.ScannedGenericBeanDefinition，
